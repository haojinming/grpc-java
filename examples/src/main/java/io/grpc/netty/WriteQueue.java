...
public class WriteQueue {
  ...
  static final Logger logger = Logger.getLogger(WriteQueue.class.getName());
  ...
  private void flush() {
    ...
    logger.info("Write queue start flush.");
    ...
    String logMsg = String.format("writequeue takes %d ms.", (endTime - startTime));
    logger.info(logMsg);
  }
